(() => {
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/colors/keywords.mjs
  var colorKeywords = {
    transparent: {
      type: "transparent"
    },
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/colors/index.mjs
  ...
  function fromFunction(value) {
    ...
    if (typeof alphaStr === "string") {
      ...
      const index2 = alphaStr.indexOf("%");
      const hasPercentage = index2 !== -1;
      if (isNaN(alpha) || hasPercentage && index2 !== alphaStr.length - 1) {
        return null;
      }
      if (hasPercentage) {
        alpha /= 100;
    ...
    for (let i = 0; i < 3; i++) {
      ...
      const index2 = colorStr.indexOf("%");
      const hasPercentage = index2 !== -1;
      if (hasPercentage && index2 !== colorStr.length - 1) {
        return null;
      }
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/data/tags.mjs
  var badTags = /* @__PURE__ */ new Set([
  ...
  var unsupportedTags = /* @__PURE__ */ new Set(["metadata", "desc", "title"]);
  var styleTag = /* @__PURE__ */ new Set(["style"]);
  var defsTag = /* @__PURE__ */ new Set(["defs"]);
  var maskTags = /* @__PURE__ */ new Set(["clipPath", "mask"]);
  var symbolTag = /* @__PURE__ */ new Set(["symbol"]);
  var shapeTags = /* @__PURE__ */ new Set([
    "circle",
    "ellipse",
    "line",
    "path",
  ...
  var useTag = /* @__PURE__ */ new Set(["use"]);
  var groupTag = /* @__PURE__ */ new Set(["g"]);
  var markerTag = /* @__PURE__ */ new Set(["marker"]);
  var animateTags = /* @__PURE__ */ new Set([
    "animate",
    "animateMotion",
    "animateTransform",
    "discard",
  ...
  var animateMotionChildTags = /* @__PURE__ */ new Set(["mpath"]);
  var gradientTags = /* @__PURE__ */ new Set(["linearGradient", "radialGradient"]);
  var gradientChildTags = /* @__PURE__ */ new Set(["stop"]);
  var patternTag = /* @__PURE__ */ new Set(["pattern"]);
  var filterTag = /* @__PURE__ */ new Set(["filter"]);
  var feLightningTags = /* @__PURE__ */ new Set([
    "feDiffuseLighting",
    "feSpecularLighting"
  ]);
  var filterChildTags = /* @__PURE__ */ new Set([
    "feBlend",
    "feColorMatrix",
    "feComponentTransfer",
    "feComposite",
  ...
  var feComponentTransferChildTag = /* @__PURE__ */ new Set([
    "feFuncR",
    "feFuncG",
    "feFuncB",
    "feFuncA"
  ]);
  var feLightningChildTags = /* @__PURE__ */ new Set([
    "feSpotLight",
    "fePointLight",
    "feDistantLight"
  ]);
  var feMergeChildTags = /* @__PURE__ */ new Set(["feMergeNode"]);
  var reusableElementsWithPalette = /* @__PURE__ */ new Set([
    ...gradientTags,
    ...patternTag,
    ...markerTag,
    ...symbolTag,
  ...
  var allValidTags = /* @__PURE__ */ new Set([
    ...styleTag,
    ...defsTag,
    ...maskTags,
    ...symbolTag,
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parser/error.mjs
  function styleParseError(message, code, index2) {
    let fullMessage = message;
    if (typeof index2 === "number" && index2 !== -1) {
      const start = index2;
      const remaining = code.slice(index2) + "!";
      const trimmed = remaining.trim();
      const end2 = start + remaining.length - trimmed.length;
      const code2 = code.slice(0, end2);
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parser/strings.mjs
  function findEndOfQuotedString(code, quote, start) {
    let nextEscape = code.indexOf("\\", start + 1);
    let end2 = code.indexOf(quote, start + 1);
    if (end2 === -1) {
      return null;
    }
    while (nextEscape !== -1 && nextEscape < end2) {
      if (end2 === nextEscape + 1) {
        end2 = code.indexOf(quote, end2 + 1);
        if (end2 === -1) {
          return null;
        }
      }
  ...
  function findEndOfURL(code, start) {
    let index2 = (start || 0) + 4;
    const length = code.length;
    while (true) {
      if (index2 >= length) {
        return styleParseError("Cannot find end of URL", code, start);
      }
      let next2 = code.charAt(index2);
      switch (next2) {
        case '"':
        case "'": {
          let end2 = findEndOfQuotedString(code, next2, index2);
          if (end2 === null) {
            return styleParseError("Incomplete string", code, index2);
          }
          end2 = code.indexOf(")", end2);
          return end2 === -1 ? styleParseError("Cannot find end of URL", code, start) : end2 + 1;
        }
        case " ":
        case "	":
        case "\r":
        ...
        default:
          while (true) {
            ...
            next2 = code.charAt(index2);
          }
      }
    }
  }

  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parser/text.mjs
  ...
  function textTokensToRule(tokens) {
    ...
    prop2 = prop2.trim();
    value = value.trim();
    if (!prop2.length || !value.length) {
      return null;
    }
    const result = {
      type: "rule",
      prop: prop2.toLowerCase(),
      value,
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parser/tokens.mjs
  function findTokens(code, tokens) {
    ...
    tokens.forEach((token) => {
      let index2 = 0;
      while (true) {
        index2 = lc.indexOf(token, index2);
        if (index2 === -1) {
          return;
        }
        list.push({
  ...
  function getTokens(css2) {
    const items = [];
    let textQueue = [];
    let start = 0;
    let depth = 0;
    try {
      const checkRule = (text3) => {
        if (!textQueue.length) {
          return;
        }
        ...
        const value = mergeTextTokens(textQueue) + text3;
        if (!value.length) {
          return;
        }
        throw styleParseError("Invalid css rule", css2, textQueue[0]?.index);
      };
      findTokens(css2, ['"', "'", "/*", "{", "}", ";", "url(", "\\"]).forEach(
        (token) => {
          ...
          switch (token.token) {
            case "/*": {
              textQueue.push({
                type: "chunk",
                text: css2.slice(start, token.index),
                index: start
              });
              start = token.index;
              const end2 = css2.indexOf("*/", start + 2);
              if (end2 === -1) {
            ...
            case "\\":
              textQueue.push({
                type: "chunk",
                text: css2.slice(start, token.index + 2),
                index: start
              });
              start = token.index + 2;
              break;
            case "url(": {
              ...
              start = token.index;
              const end2 = findEndOfURL(css2, start);
              if (typeof end2 !== "number") {
                throw end2;
              }
              textQueue.push({
                type: "url",
                text: css2.slice(start, end2),
                index: start
              });
              start = end2;
              break;
            ...
            case "'": {
              ...
              start = token.index;
              const end2 = findEndOfQuotedString(
                css2,
                token.token,
                start
              );
      ...
      if (depth) {
        return styleParseError("Missing }", css2);
      }
      textQueue.push({
        type: "chunk",
        text: css2.slice(start),
        index: start
      });
      checkRule("");
    } catch (err) {
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parse.mjs
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parser/export.mjs
  var tab = "	";
  var nl = "\n";
  ...
  function parseToken(token, compact, depth) {
    ...
    const children2 = token.children.map((item) => {
      return parseToken(item, compact, depth + 1);
    });
    return (compact ? "" : tab.repeat(depth)) + content + (compact ? "{" : " {" + nl) + children2.join("") + (compact ? "}" : tab.repeat(depth) + "}" + nl);
  }
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/css/parser/tree.mjs
  function tokensTree(tokens) {
    const result = [];
    let index2 = 0;
    function parse6(target) {
      while (index2 < tokens.length) {
        ...
        switch (token.type) {
          ...
          case "at-rule": {
            ...
            target.push(newItem);
            parse6(newItem.children);
            if (!newItem.children.length) {
              const index22 = target.indexOf(newItem);
              if (index22 !== -1) {
                target.splice(index22, 1);
              }
            }
            break;
          }
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/parse.mjs
  async function parseSVG(svg, callback) {
    async function checkNode(element, parents2) {
      if (element.type !== "tag") {
        return;
      }
      ...
      const newParents = parents2.slice(0);
      newParents.unshift(item);
      if (tagName !== "style" && item.testChildren && !item.removeNode) {
        const children2 = $element.children().toArray();
        for (let i = 0; i < children2.length; i++) {
          await checkNode(children2[i], newParents);
        }
      }
      if (item.removeNode) {
        $element.remove();
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/parse-style.mjs
    ...
    return parseSVG(svg, async (item) => {
      ...
      if (tagName === "style") {
        ...
        for (let i = 0; i < tokens.length; i++) {
          ...
          const selectorTokens = selectorStart.map((index2) => newTokens[index2]).filter((item2) => item2 !== null);
          let result = callback({
            type: "global",
            prop: token.prop,
            value,
            ...
            selectors: selectorTokens.reduce(
              (prev2, current) => {
                switch (current.type) {
                  case "selector": {
                    return prev2.concat(current.selectors);
                  }
                }
                return prev2;
              },
      ...
      for (let i = 0; i < props.length; i++) {
        ...
        if (result !== value) {
          changed = true;
          if (result === void 0) {
            delete parsedStyle[prop2];
          } else {
            parsedStyle[prop2] = result;
          }
        }
      }
      if (!changed) {
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/colors/attribs.mjs
  ...
  var allowDefaultColorValue = {
    "stop-color": true,
    "flood-color": "flood-opacity"
  };

  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/data/attributes.mjs
  var badAttributes = /* @__PURE__ */ new Set([
    "cursor",
    "pointer-events",
    "shape-rendering",
    "tabindex",
  ...
  var junkSVGAttributes = /* @__PURE__ */ new Set([
    "xmlns:xlink",
    "baseProfile",
    "contentScriptType",
    "contentStyleType",
  ...
  var badSoftwareAttributes = /* @__PURE__ */ new Set([
    "isolation",
    "enable-background",
    "overflow",
    "marker",
  ...
  var badAttributePrefixes = /* @__PURE__ */ new Set([
    "image",
    "mix",
    "block",
    "data",
  ...
  var commonAttributes = /* @__PURE__ */ new Set(["id"]);
  var stylingAttributes = /* @__PURE__ */ new Set(["class", "style"]);
  var insideClipPathAttributes = /* @__PURE__ */ new Set(["clip-rule"]);
  var fillPresentationalAttributes = /* @__PURE__ */ new Set([
    "fill-opacity",
    "fill-rule"
  ]);
  var strokePresentationalAttributes = /* @__PURE__ */ new Set([
    "stroke-dasharray",
    "stroke-dashoffset",
    "stroke-linecap",
    "stroke-linejoin",
  ...
  var urlPresentationalAttributes = /* @__PURE__ */ new Set([
    "clip-path",
    "filter",
    "mask"
  ]);
  var visibilityPresentationalAttributes = /* @__PURE__ */ new Set([
    "display",
    "opacity",
    "visibility"
  ]);
  var commonColorPresentationalAttributes = /* @__PURE__ */ new Set([
    "color",
    "fill",
    "stroke"
  ]);
  var otherPresentationalAttributes = /* @__PURE__ */ new Set([
    "color-interpolation",
    "color-rendering",
    "transform",
    "vector-effect"
  ]);
  var presentationalAttributes = /* @__PURE__ */ new Set([
  ...
  var markerAttributes = /* @__PURE__ */ new Set([
    "marker-start",
    "marker-mid",
    "marker-end"
  ]);
  var otherShapeAttributes = /* @__PURE__ */ new Set(["pathLength"]);
  var animationTimingAttributes = /* @__PURE__ */ new Set([
    "begin",
    "dur",
    "end",
    "min",
  ...
  var animationValueAttributes = /* @__PURE__ */ new Set([
    "calcMode",
    "values",
    "keyTimes",
    "keySplines",
  ...
  var otherAnimationAttributes = /* @__PURE__ */ new Set([
    "attributeName",
    "additive",
    "accumulate"
  ]);
  var commonGradientAttributes = /* @__PURE__ */ new Set([
    "gradientUnits",
    "gradientTransform",
    "href",
    "spreadMethod"
  ]);
  var commonFeAttributes = /* @__PURE__ */ new Set([
    "x",
    "y",
    "width",
    "height",
  ...
  var feFuncAttributes = /* @__PURE__ */ new Set([
    "type",
    "tableValues",
    "slope",
    "intercept",
  ...
  var tagSpecificInlineStyles = {
    mask: /* @__PURE__ */ new Set(["mask-type"])
  };

  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/analyse/error.mjs
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/analyse.mjs
  async function analyseSVGStructure(svg, options = {}) {
    const fixErrors = options.fixErrors;
    let root3 = svg.$svg(":root").get(0);
    if (root3._parsed) {
      svg.load(svg.toString());
      root3 = svg.$svg(":root").get(0);
    }
    root3._parsed = true;
    const cheerio = svg.$svg;
    ...
    await parseSVG(svg, (item) => {
      const { tagName, parents: parents2 } = item;
      ...
      const attribs = element.attribs;
      index2++;
      element._index = index2;
      elements.set(index2, element);
      if (!parents2.length) {
      ...
      if (maskTags.has(tagName)) {
        ...
        parentElement._childElements.push(index2);
      ...
      Object.keys(attribs).forEach((attr2) => {
        let value = attribs[attr2];
        ...
        if (urlPresentationalAttributes.has(attr2)) {
          gotElementReference(item, id, attr2 !== "filter");
          return;
        }
        if (commonColorPresentationalAttributes.has(attr2) || markerAttributes.has(attr2)) {
          gotElementReference(item, id, false);
          return;
        }
      });
    ...
    links = links.filter((item) => {
      ...
      function fix() {
        const index22 = item.usedByIndex;
        const element = elements.get(index22);
        const tagName = element.tagName;
        function remove2() {
          const $element = cheerio(element);
          const parent2 = element.parent;
          if (parent2) {
            if (parent2._childElements) {
              parent2._childElements = parent2._childElements.filter(
                (num) => num !== index22
              );
            }
            parent2._belongsTo?.forEach((list) => {
              list.indexes.delete(index22);
            });
          }
          $element.remove();
        }
        ...
        const attribs = element.attribs;
        for (const attr2 in attribs) {
          if (matches.has(attribs[attr2])) {
            cheerio(element).removeAttr(attr2);
          }
        }
      }
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/colors/parse.mjs
  ...
  async function parseColors(svg, options = {}) {
    ...
    function findColor(color, add3 = false) {
    ...
    function addColorToItem(prop2, color, item, add3 = true) {
      const addedColor = findColor(color, add3 !== false);
      if (item) {
        const itemColors = item._colors || (item._colors = {});
        itemColors[prop2] = addedColor === null ? color : addedColor;
      }
    }
    function getElementColor(prop2, item, elements2) {
      function find4(prop22) {
        let currentItem = item;
        const allowDefaultColor = allowDefaultColorValue[prop22];
        while (currentItem) {
          const element = elements2.get(
            currentItem.index
          );
          const color = element._colors?.[prop22];
          if (color !== void 0) {
            return color;
          }
          ...
          if (currentItem?.usedAsMask) {
            return defaultColorValues[prop22];
          }
        }
        return defaultColorValues[prop22];
      }
      let propColor = find4(prop2);
      if (propColor !== null && typeof propColor === "object" && propColor.type === "current" && prop2 !== "color") {
        propColor = find4("color");
      }
      return propColor;
    }
    async function checkColor(prop2, value, item) {
      ...
      if (parsedColor?.type === "function" && parsedColor.func === "url") {
        addColorToItem(prop2, defaultValue, item, false);
        return value;
      }
      if (!options.callback) {
        addColorToItem(prop2, defaultValue, item);
        return value;
      }
      ...
      if (typeof callbackResult === "string") {
        ...
        addColorToItem(prop2, newColor || callbackResult, item);
        return callbackResult;
      }
      const newValue = colorToString(callbackResult);
      addColorToItem(prop2, callbackResult, item);
      return newValue;
    }
    await parseSVGStyle(svg, async (item) => {
      const prop2 = item.prop;
      const value = item.value;
      if (propsToCheck.indexOf(prop2) === -1) {
        return value;
      }
      const attr2 = prop2;
      const newValue = await checkColor(attr2, value);
      if (newValue === void 0) {
        return newValue;
      }
      if (item.type === "global") {
    ...
    function removeElement2(index2, element) {
      function removeChildren(element2) {
        element2.children.forEach((item) => {
          ...
          const element3 = item;
          const index22 = element3._index;
          if (index22 && !removedElements.has(index22)) {
            element3._removed = true;
            removedElements.add(index22);
    ...
    async function parseTreeItem(item) {
      ...
      if (removedElements.has(index2) || parsedElements.has(index2)) {
        return;
      }
      parsedElements.add(index2);
      ...
      for (let i = 0; i < propsToCheck.length; i++) {
        const prop2 = propsToCheck[i];
        if (prop2 === "fill" && animateTags.has(tagName)) {
          continue;
        }
        const value = attribs[prop2];
        if (value !== void 0) {
          const newValue = await checkColor(prop2, value, element);
          if (newValue !== value) {
            if (newValue === void 0) {
              cheerio(element).removeAttr(prop2);
              if (element._colors) {
                delete element._colors[prop2];
              }
            } else if (newValue === "remove") {
              removeElement2(index2, element);
              return;
            } else {
              cheerio(element).attr(prop2, newValue);
            }
          }
        }
      }
      if (animateTags.has(tagName)) {
        const attr2 = attribs.attributeName;
        if (propsToCheck.indexOf(attr2) !== -1) {
      ...
      if (!result.hasGlobalStyle) {
        ...
        specialColorAttributes.forEach((attr2) => {
          if (tagSpecificPresentationalAttributes[tagName]?.has(attr2)) {
            requiredProps = [attr2];
          }
        });
        if (requiredProps) {
          ...
          for (let i = 0; i < requiredProps.length; i++) {
            const prop2 = requiredProps[i];
            const color = getElementColor(prop2, item, elements);
            if (color === defaultBlackColor) {
              if (defaultColor) {
                ...
                itemColors[prop2] = defaultColorValue;
              } else {
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/cleanup/attribs.mjs
  async function removeBadAttributes(svg) {
    await parseSVG(svg, (item) => {
      ...
      const $element = item.$element;
      Object.keys(attribs).forEach((attr2) => {
        if (attr2.slice(0, 2) === "on" || badAttributes.has(attr2) || badSoftwareAttributes.has(attr2) || badAttributePrefixes.has(attr2.split("-").shift())) {
          $element.removeAttr(attr2);
          return;
        }
        if (defsTag.has(tagName) && !tagSpecificPresentationalAttributes[tagName].has(attr2)) {
          $element.removeAttr(attr2);
          return;
        }
        const nsParts = attr2.split(":");
        if (nsParts.length > 1) {
          ...
          switch (namespace) {
            case "xlink": {
              if (attribs[newAttr] === void 0) {
                $element.attr(newAttr, attribs[attr2]);
              }
              break;
            }
          }
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/cleanup/bad-tags.mjs
  var requiredParentTags = /* @__PURE__ */ new Map();
  ...
  async function checkBadTags(svg) {
    await parseSVG(svg, (item) => {
      ...
      for (const [parents2, children2] of requiredParentTags) {
        if (children2.has(tagName)) {
          if (!parents2.has(parentTagName)) {
            throw new Error(
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/cleanup/inline-style.mjs
    ...
    await parseSVG(svg, (item) => {
      ...
      if (attribs.style) {
        ...
        if (parsedStyle === null) {
          ...
          const checkRule = (prop2, value) => {
            function warn() {
              console.warn(
                `Removing unexpected style on "${tagName}": ${prop2}`
              );
            }
            if (badAttributes.has(prop2) || tagSpecificNonPresentationalAttributes[tagName]?.has(
              prop2
            )) {
              return;
            }
            if (tagSpecificAnimatedAttributes[tagName]?.has(prop2) || tagSpecificPresentationalAttributes[tagName]?.has(prop2)) {
              $element.attr(prop2, value);
              return;
            }
            if (tagSpecificInlineStyles[tagName]?.has(prop2)) {
              newStyle[prop2] = value;
              return;
            }
            if (insideClipPathAttributes.has(prop2)) {
            ...
            if (badSoftwareAttributes.has(prop2) || badAttributePrefixes.has(
              prop2.split("-").shift()
            )) {
              return;
            }
          ...
          for (const prop2 in parsedStyle) {
            checkRule(prop2, parsedStyle[prop2]);
          }
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/cleanup/root-style.mjs
  ...
  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/cleanup/root-svg.mjs
  function cleanupSVGRoot(svg) {
    const cheerio = svg.$svg;
    const $root = svg.$svg(":root");
    const root3 = $root.get(0);
    const tagName = "svg";
    if (root3.tagName !== tagName) {
      throw new Error(`Unexpected root tag <${root3.tagName}>`);
    }
    const attribs = root3.attribs;
    const moveToChildren = {};
    Object.keys(attribs).forEach((attr2) => {
      const value = attribs[attr2];
      if (commonAttributes.has(attr2) || badAttributes.has(attr2) || junkSVGAttributes.has(attr2) || badSoftwareAttributes.has(attr2) || badAttributePrefixes.has(attr2.split("-").shift()) || attr2.split(":").length > 1) {
        $root.removeAttr(attr2);
        return;
      }
      switch (attr2) {
        case "width":
      ...
      if (tagSpecificNonPresentationalAttributes[tagName]?.has(attr2)) {
        return;
      }
      if (tagSpecificPresentationalAttributes[tagName]?.has(attr2) && tagSpecificPresentationalAttributes.g.has(attr2)) {
        moveToChildren[attr2] = value;
        $root.removeAttr(attr2);
        return;
      }
      if (stylingAttributes.has(attr2)) {
        switch (attr2) {
          case "style":
            return;
          case "class":
        ...
        throw new Error(`Unexpected attribute "${attr2}" on <${tagName}>`);
      }
      if (
        // Events
        attr2.slice(0, 2) === "on" || // aria-stuff
        attr2.slice(0, 5) === "aria-" || // Junk
        attr2.slice(0, 6) === "xmlns:"
      ) {
        $root.removeAttr(attr2);
        return;
      }
      console.warn(`Removing unexpected attribute on SVG: ${attr2}`);
      $root.removeAttr(attr2);
    });
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/icon/defaults.mjs
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/customisations/defaults.mjs
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/svg/size.mjs
  ...
  function calculateSize(size, ratio, precision) {
    ...
    let isNumber3 = unitsTest.test(code);
    while (true) {
      if (isNumber3) {
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/svg/defs.mjs
  function splitSVGDefs(content, tag = "defs") {
    ...
    while (index2 >= 0) {
      ...
      defs += content.slice(start + 1, end2).trim();
  ...
  function wrapSVGContent(body, start, end2) {
    const split = splitSVGDefs(body);
    return mergeDefsAndContent(split.defs, start + split.content + end2);
  }

  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/svg/build.mjs
  ...
  function iconToSVG(icon, customisations) {
    ...
    const attributes2 = {};
    const setAttr2 = (prop2, value) => {
      if (!isUnsetKeyword(value)) {
        attributes2[prop2] = value.toString();
      }
    };
    setAttr2("width", width);
    setAttr2("height", height);
  ...
  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/svg/trim.mjs
  function trimSVG(str) {
    return str.replace(/(['"])\s*\n\s*([^>\\/\s])/g, "$1 $2").replace(/(["';{}><])\s*\n\s*/g, "$1").replace(/\s*\n\s*/g, " ").replace(/\s+"/g, '"').replace(/="\s+/g, '="').replace(/(\s)+\/>/g, "/>").trim();
  }

  // node_modules/.pnpm/@iconify+utils@2.1.25/node_modules/@iconify/utils/lib/index.mjs
  var import_debug = __toESM(require_browser(), 1);

  // node_modules/.pnpm/@iconify+tools@2.2.6/node_modules/@iconify/tools/lib/svg/index.mjs
  var SVG = class {
    /**
     * Constructor
     */
    ...
    toString(customisations) {
      if (customisations) {
        const data2 = iconToSVG(this.getIcon(), customisations);
        let svgAttributes = ' xmlns="http://www.w3.org/2000/svg"';
        if (data2.body.indexOf("xlink:") !== -1) {
          svgAttributes += ' xmlns:xlink="http://www.w3.org/1999/xlink"';
        }
        for (const key in data2.attributes) {
          const value = data2.attributes[key];
          svgAttributes += " " + key + '="' + value + '"';
        }
        return "<svg" + svgAttributes + ">" + data2.body + "</svg>";
      }
     ...
     */
    load(content) {
      function remove2(str1, str2, append3) {
        let start = 0;
        while ((start = content.indexOf(str1, start)) !== -1) {
          const end2 = content.indexOf(str2, start + str1.length);
          if (end2 === -1) {
            return;
          }
          content = content.slice(0, start) + append3 + content.slice(end2 + str2.length);
          start = start + append3.length;
        }
      }
      remove2("<!--", "-->", "");
      remove2("<?xml", "?>", "");
      remove2("<!DOCTYPE svg", "<svg", "<svg");
      remove2(
        'xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"',
        "",
        ""
      );
      remove2('xml:space="preserve"', "", "");
      content = content.replace(/<g>\s*<\/g>/g, "");
      this.$svg = esm_default2.load(content.trim(), {
      ...
      Object.keys(this.viewBox).forEach((key) => {
        const attr2 = key;
        if (isNaN(this.viewBox[attr2])) {
          throw new Error(`Invalid SVG file: invalid ${attr2}`);
        }
      });
    }
  };
  ...
  var reactTemplate = (svgName, svgStr) => {
    ...
    svgStr = svgStr.replace(/style="([^"]+)"/g, (all, style) => {
      const styleObj = style.split(";").reduce((obj, item) => {
        ...
        key = key.trim().replace(/-([a-z])/g, (all2, letter) => letter.toUpperCase());
        if (key && value) {
          obj[key] = value;
        }
        return obj;
  ...
  window.iconfontRunMain = async () => {
    everytime(
      () => document.querySelector("ul.preview-dropdown") && !document.getElementById("download-iconify"),
      () => {
    ...
    everytime(
      () => !!document.querySelector(".mp-e2e-content .download-btns") && !document.getElementById("react-download"),
      () => {
  ...
  function toCamelCase(str) {
    str = removeBadWords(str);
    return str.replace(/ /g, "-").replace(/_(\w)/g, (all, letter) => letter.toUpperCase()).replace(/-(\w)/g, (all, letter) => letter.toUpperCase()).replace(/^[a-z]/, (s) => s.toUpperCase());
  }
